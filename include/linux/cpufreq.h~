...
#elif defined(CONFIG_CPU_FREQ_DEFAULT_GOV_RIKTAURUS)
extern struct cpufreq_governor cpufreq_gov_riktaurus;
#define CPUFREQ_DEFAULT_GOVERNOR	(&cpufreq_gov_riktaurus)
